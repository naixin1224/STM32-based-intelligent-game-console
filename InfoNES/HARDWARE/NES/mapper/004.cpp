...
uint32_t chr_swap() { return MAPx->regs[0] & 0x80; }
uint32_t prg_swap() { return MAPx->regs[0] & 0x40; }
...
void MAP4_MemoryWrite(uint16_t addr, uint8_t data)
{
  switch(addr & 0xE001)
  {
    case 0x8000: 
