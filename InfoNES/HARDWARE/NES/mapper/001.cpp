...
{  
  ...
  MAP1->regs[3] = 0x00;
  {
    uint32_t size_in_K = num_8k_ROM_banks * 8;
    if(size_in_K == 1024)
    {
...
void MAP1_MemoryWrite(uint16_t addr, uint8_t data)
{  
  uint32_t reg_num;
