...
/*以下为OV7670 QVGA RGB565参数  */
	...
	{0xa2, 0x02},//15
	{0x11, 0x82},//时钟分频设置,F(内部时钟) = F(输入时钟)/(位[5:0]+1),范围[5:0]:0000-ffff
	{0x7a, 0x20},
	{0x7b, 0x1c},
	{0x7c, 0x28},
	...
	{0x10, 0x00},
	{0x0d, 0x00},//位[5:4]: 00全窗口， 01 半窗口，10 1/4窗口，11 1/4窗口 
...
//3,1
//4,2
void OV7670_Contrast(uint8_t contras)
{
...
{
	if(GPIO_Pin == OV7670_VSYNC_PIN)	//是8线的中断
	{      
		if(OV7670_STA < 2)
		{
			if(OV7670_STA == 0)
